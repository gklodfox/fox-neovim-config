...
M.dependencies = {
    ...
    "aaditeynair/conduct.nvim", "nvim-telescope/telescope-frecency.nvim",
...
function M.opts()
    ...
    return {
        ...
        defaults = {
            vimgrep_arguments = {
                "rg", "--color=never", "--no-heading", "--hidden", "--glob",
                "!**/.git/*", "--with-filename", "--line-number", "--column",
        ...
        extensions = {
            themes = {
                ...
                layout_config = {horizontal = {width = 0.8, height = 0.7}},
...
function M.config(_, opts)
    ...
    local enabled_extensions = {
        "themes", "fzf", "ui-select", "frecency", "conduct", "live_grep_args",
        "search_dir_picker", "cmdline"
    }
