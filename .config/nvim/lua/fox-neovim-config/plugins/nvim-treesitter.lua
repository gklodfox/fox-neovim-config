...
function M.opts()
    return {
        ensure_installed = {
            "dap_repl", "vimdoc", "c", "lua", "luadoc", "luap", "printf",
            "regex", "toml", "xml", "latex", "rust", "jsonc", "bash", "vim",
            "query", "markdown", "groovy", "markdown_inline", "python", "cpp",
            "fish", "json", "yaml", "gitignore", "bash", "diff", "html"
        },
        autotag = {enable = true},
        ...
        textobjects = {
            ...
            move = {
                ...
                goto_previous_start = {
                    ["[f"] = {
                        query = "@call.outer",
                        desc = "Previous function def start"
                    },
                    ["[m"] = {
                        query = "@function.outer",
                ...
                goto_previous_end = {
                    ["]F"] = {
                        query = "@call.outer",
                        desc = "Previous function def end"
                    },
                    ["]M"] = {
                        query = "@function.outer",
