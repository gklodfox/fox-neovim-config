...
function M.config(_, opts)
  ...
  npairs.add_rules({
    Rule("x%d%d%d%d$", "number", "lua"):use_regex(true):replace_endpair(function(opt)
  ...
  npairs.add_rules({
    Rule("b%d%d%d%d%w$", "", "vim"):use_regex(true, "<tab>"):replace_endpair(function(opt)
      return opt.prev_char:sub(#opt.prev_char - 4, #opt.prev_char) .. "<esc>viwU"
    end),
  })
